...
const Todo = ({ todo }) => { //creates a component by declaring a constant variable that contains a function that destructures the passed in prop grabing the passed in todo item
